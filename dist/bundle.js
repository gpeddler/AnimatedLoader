...
/***/ function(module, exports, __webpack_require__) {
	...
	var colors = [[40, 235, 169], [67, 205, 245]];

	_reactDom2.default.render(_react2.default.createElement(_loader2.default, { speed: 3, text: 'FNIXA', colors: colors }), document.getElementById("wrap"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loader = (function (_React$Component) {
	    ...
	    function Loader(props) {
	        ...
	        _this.speed = props.speed;
	        _this.text = props.text;
	        _this.color = props.colors;
	        return _this;
	    }
	    ...
	    _createClass(Loader, [{
	        ...
	        value: function render() {
	            var size = (this.radius + this.padding) * 2 + "px";

	            return _react2.default.createElement('canvas', { className: 'test', width: size, height: size });
	        }
	    }, {
	        key: '_initCanvas',
	        ...
	        key: '_drawCanvas',
	        value: function _drawCanvas(context) {
	        ...
	        value: function _drawCircleLight(context) {
	            context.globalCompositeOperation = "source-atop";

	            var gradient = context.createRadialGradient(this._dot.x, this._dot.y, 0, this._dot.x, this._dot.y, 200);
	        ...
	        key: '_drawBlurCircle',
	        value: function _drawBlurCircle(context, size, alpha) {
	            context.beginPath();
